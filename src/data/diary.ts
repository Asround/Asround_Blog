...
const diaryData: DiaryItem[] = [
	...
	},
	{
		id: 10,
		content:
			"改左手机箱, 寝室机位重新规划.<br/>宿舍的书柜简直无力吐槽, 桌面空间高度无法放下机箱, 放显示器也是及其局促, 都必须买个小桌才能保证正常使用. 最奇葩的还是书柜层高无法竖放大部分标准大小书籍, 不过这不在此次改造范围内了.<br/>昨晚逛b 站的时候发现CH270可以改左手机箱, 只需要把底座改一下方向就行. 只是之前理线有点极限, 导致调整花了一点时间, 不过依旧还是个把小时就弄好了, 基本恢复之前笔记本时期的布局.",
		date: "2026-05-24T09:30:00Z",
		images: [
			"/images/diary/2026-05-24/layout1.webp",
			"/images/diary/2026-05-24/layout2.webp",
		],
	},
	{
		id: 11,
		content:
			"收获一盒绿豆沙冰.<br/>飞扬群里看到有群友要m2螺丝, 没标校区以为是江安的, 就没回. 结果水了一会儿群之后刷集市, 看到这位bro发帖说自己是望江的(联系方式可查, 通过QQ号一致来确定). 于是群里回复送他了一个, bro太性情了骑车赶过来还带了一杯饮料, 可惜刚喝了牛奶无福消受.",
		date: "2026-05-26T23:15:00Z",
		images: ["/images/diary/2026-05-26/drink.webp"],
	},
];
